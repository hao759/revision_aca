...
@Component({
  selector: 'app-blue-force-detect',
  templateUrl: './blue-force-detect.component.html',
  styleUrl: './blue-force-detect.component.scss',
...
// export class AttendanceVerifyComponent {
export class BlueForceDetectComponent {
  constructor(
