...
import { UmerDemoService } from './umer-demo.service';
...
@Component({
  ...
  templateUrl: './umer-demo.component.html',
  styleUrl: './umer-demo.component.scss'
})
export class UmerDemoComponent {
  audit_id: any = 9999
...
// -shop_code,
// -emp_code,
// -project_name, kpi_name, unique_code
